# DevOps Toolchain Rapid Risk Assessment

The DM DevOps toolchain includes a number of on-premise services for automating the build and deployment for secure cloud-based systems.

[OpenVSCode Server](https://code.sans.labs/?workspace=/home/student/sec540.code-workspace) - Open-source development environment for editing source code, viewing scan results, and running Terminal commands.

[GitLab](https://gitlab.sans.labs) - Open-source version control system.

[HashiCorp Vault](https://vault.sans.labs) - Open-source secrets management system.
